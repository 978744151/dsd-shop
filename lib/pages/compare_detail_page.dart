...
class _CompareDetailPageState extends State<CompareDetailPage> {
  ...
  Future<void> _captureAndShowImage(BuildContext context, ScreenshotController controller) async {
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => _captureAndShowImage(context, _screenshotController),
